...
/// - MORE_INFO_GAMEDATA
///
@interface bfgPurchaseObject : NSObject <NSCoding, NSCopying>
...
/// \details Set to the current time when the user initiates a
/// purchase.
@property (nonatomic, strong) NSDate            *purchaseStart;
