///  \file bfgSplash.h
///  \brief Displays Big Fish newsletter.
///
...
/// \details Sets the user setting that the Newsletter has been sent. 
...
/// \details Gets the user setting that the Newsletter has been sent.
/// This value is updated on the first successful connection to the Big Fish server
/// on the initial launch of the game. After that, the client can update the value locally.
