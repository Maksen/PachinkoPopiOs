...
///
/// \brief Manages Apple's In-App Purchases.
///
...
///
/// Occassionally a game will need to support functionality beyond what is provided
...
///
/// Use this method if you wish to present the UI to users as they begin the purchase
/// process. If no logic will occur between canStartPurchase: and startPurchase:
/// then there is no reason to call canStartPurchase: first.
///
