...
///
/// \details Removes in-memory references to all string files' values.
///
+ (void) releaseStringFiles;

///
/// \details Removes in-memory references to a string file's values.
///
/// \param name A filename / namespace.
///
+ (void) releaseStringFile:(NSString *)name;
