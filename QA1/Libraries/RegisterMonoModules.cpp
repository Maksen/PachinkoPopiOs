...
extern "C"
{
	...
	void	__BfgUtilities__addNotificationObserver();
	void	__BfgUtilities__removeNotificationObserverForObject();
	void	__BfgUtilities__removeAllNotificationObserversForObject();
	...
	void	__bfgGameReporting__logPurchasePayWallShown();
	void	__bfgGameReporting__logLevelStart();
	void	__bfgGameReporting__logLevelFinished();
	void	__bfgGameReporting__logMiniGameStart();
	void	__bfgGameReporting__logMiniGameSkipped();
	void	__bfgGameReporting__logMiniGameFinished();
	void	__bfgGameReporting__logAchievementEarned();
	void	__bfgGameReporting__logTellAFriendTapped();
	void	__bfgGameReporting__logGameCompleted();
	void	_sessionCount();
	void	_isInitialLaunch();
	void	_isFirstTime();
	void	_isInitialized();
	void	_showMoreGames();
	...
	void	_showPrivacy();
	void	_showTerms();
	void	_showWebBrowser();
	void	_removeWebBrowser();
	void	_checkForInternetConnection();
	void	_checkForInternetConnectionAndAlert();
	void	_startBranding();
	void	_stopBranding();
	void	_adsRunning();
	void	_startAds();
	void	_stopAds();
	void	__bfgPurchase__acquireProductInformation();
	void	__bfgPurchase__acquireProductInformation2();
	void	__bfgPurchase__acquireProductInformationForProducts();
	void	__bfgPurchase__canStartPurchase();
	void	__bfgPurchase__canStartPurchase2();
	void	__bfgPurchase__finishPurchase();
	void	__bfgPurchase__finishPurchase2();
	void	__bfgPurchase__isPurchaseActive();
	void	__bfgPurchase__isPurchaseActive2();
	void	__bfgPurchase__isRestoreActive();
	void	__bfgPurchase__productInformation();
	void	__bfgPurchase__productInformation2();
	void	__bfgPurchase__purchaseActivityInProgress();
	void	__bfgPurchase__restorePurchases();
	void	__bfgPurchase__startPurchase();
	void	__bfgPurchase__startPurchase2();
	void	__bfgPurchase__startPurchase3();
	void	__bfgPurchase__startService();
	void	__bfgPurchase__startService2();
	void	__bfgReporting__logEvent();
	void	__bfgReporting__logEventWithParameters();
	void	__bfgReporting__logSingleFireEvent();
...
void RegisterMonoModules()
{
	...
	mono_dl_register_symbol("__BfgUtilities__addNotificationObserver", (void*)&__BfgUtilities__addNotificationObserver);
	mono_dl_register_symbol("__BfgUtilities__removeNotificationObserverForObject", (void*)&__BfgUtilities__removeNotificationObserverForObject);
	mono_dl_register_symbol("__BfgUtilities__removeAllNotificationObserversForObject", (void*)&__BfgUtilities__removeAllNotificationObserversForObject);
	mono_dl_register_symbol("__bfgGameReporting__logMainMenuShown", (void*)&__bfgGameReporting__logMainMenuShown);
	mono_dl_register_symbol("__bfgGameReporting__logRateMenuCanceled", (void*)&__bfgGameReporting__logRateMenuCanceled);
	mono_dl_register_symbol("__bfgGameReporting__logOptionsShown", (void*)&__bfgGameReporting__logOptionsShown);
	mono_dl_register_symbol("__bfgGameReporting__logPurchaseMainMenuShown", (void*)&__bfgGameReporting__logPurchaseMainMenuShown);
	mono_dl_register_symbol("__bfgGameReporting__logPurchasePayWallShown", (void*)&__bfgGameReporting__logPurchasePayWallShown);
	mono_dl_register_symbol("__bfgGameReporting__logLevelStart", (void*)&__bfgGameReporting__logLevelStart);
	mono_dl_register_symbol("__bfgGameReporting__logLevelFinished", (void*)&__bfgGameReporting__logLevelFinished);
	mono_dl_register_symbol("__bfgGameReporting__logMiniGameStart", (void*)&__bfgGameReporting__logMiniGameStart);
	mono_dl_register_symbol("__bfgGameReporting__logMiniGameSkipped", (void*)&__bfgGameReporting__logMiniGameSkipped);
	mono_dl_register_symbol("__bfgGameReporting__logMiniGameFinished", (void*)&__bfgGameReporting__logMiniGameFinished);
	mono_dl_register_symbol("__bfgGameReporting__logAchievementEarned", (void*)&__bfgGameReporting__logAchievementEarned);
	mono_dl_register_symbol("__bfgGameReporting__logTellAFriendTapped", (void*)&__bfgGameReporting__logTellAFriendTapped);
	mono_dl_register_symbol("__bfgGameReporting__logGameCompleted", (void*)&__bfgGameReporting__logGameCompleted);
	mono_dl_register_symbol("_sessionCount", (void*)&_sessionCount);
	mono_dl_register_symbol("_isInitialLaunch", (void*)&_isInitialLaunch);
	mono_dl_register_symbol("_isFirstTime", (void*)&_isFirstTime);
	mono_dl_register_symbol("_isInitialized", (void*)&_isInitialized);
	mono_dl_register_symbol("_showMoreGames", (void*)&_showMoreGames);
	mono_dl_register_symbol("_removeMoreGames", (void*)&_removeMoreGames);
	mono_dl_register_symbol("_showSupport", (void*)&_showSupport);
	mono_dl_register_symbol("_showPrivacy", (void*)&_showPrivacy);
	mono_dl_register_symbol("_showTerms", (void*)&_showTerms);
	mono_dl_register_symbol("_showWebBrowser", (void*)&_showWebBrowser);
	mono_dl_register_symbol("_removeWebBrowser", (void*)&_removeWebBrowser);
	mono_dl_register_symbol("_checkForInternetConnection", (void*)&_checkForInternetConnection);
	mono_dl_register_symbol("_checkForInternetConnectionAndAlert", (void*)&_checkForInternetConnectionAndAlert);
	mono_dl_register_symbol("_startBranding", (void*)&_startBranding);
	mono_dl_register_symbol("_stopBranding", (void*)&_stopBranding);
	mono_dl_register_symbol("_adsRunning", (void*)&_adsRunning);
	mono_dl_register_symbol("_startAds", (void*)&_startAds);
	mono_dl_register_symbol("_stopAds", (void*)&_stopAds);
	mono_dl_register_symbol("__bfgPurchase__acquireProductInformation", (void*)&__bfgPurchase__acquireProductInformation);
	mono_dl_register_symbol("__bfgPurchase__acquireProductInformation2", (void*)&__bfgPurchase__acquireProductInformation2);
	mono_dl_register_symbol("__bfgPurchase__acquireProductInformationForProducts", (void*)&__bfgPurchase__acquireProductInformationForProducts);
	mono_dl_register_symbol("__bfgPurchase__canStartPurchase", (void*)&__bfgPurchase__canStartPurchase);
	mono_dl_register_symbol("__bfgPurchase__canStartPurchase2", (void*)&__bfgPurchase__canStartPurchase2);
	mono_dl_register_symbol("__bfgPurchase__finishPurchase", (void*)&__bfgPurchase__finishPurchase);
	mono_dl_register_symbol("__bfgPurchase__finishPurchase2", (void*)&__bfgPurchase__finishPurchase2);
	mono_dl_register_symbol("__bfgPurchase__isPurchaseActive", (void*)&__bfgPurchase__isPurchaseActive);
	mono_dl_register_symbol("__bfgPurchase__isPurchaseActive2", (void*)&__bfgPurchase__isPurchaseActive2);
	mono_dl_register_symbol("__bfgPurchase__isRestoreActive", (void*)&__bfgPurchase__isRestoreActive);
	mono_dl_register_symbol("__bfgPurchase__productInformation", (void*)&__bfgPurchase__productInformation);
	mono_dl_register_symbol("__bfgPurchase__productInformation2", (void*)&__bfgPurchase__productInformation2);
	mono_dl_register_symbol("__bfgPurchase__purchaseActivityInProgress", (void*)&__bfgPurchase__purchaseActivityInProgress);
	mono_dl_register_symbol("__bfgPurchase__restorePurchases", (void*)&__bfgPurchase__restorePurchases);
	mono_dl_register_symbol("__bfgPurchase__startPurchase", (void*)&__bfgPurchase__startPurchase);
	mono_dl_register_symbol("__bfgPurchase__startPurchase2", (void*)&__bfgPurchase__startPurchase2);
	mono_dl_register_symbol("__bfgPurchase__startPurchase3", (void*)&__bfgPurchase__startPurchase3);
	mono_dl_register_symbol("__bfgPurchase__startService", (void*)&__bfgPurchase__startService);
	mono_dl_register_symbol("__bfgPurchase__startService2", (void*)&__bfgPurchase__startService2);
	mono_dl_register_symbol("__bfgReporting__logEvent", (void*)&__bfgReporting__logEvent);
	mono_dl_register_symbol("__bfgReporting__logEventWithParameters", (void*)&__bfgReporting__logEventWithParameters);
	mono_dl_register_symbol("__bfgReporting__logSingleFireEvent", (void*)&__bfgReporting__logSingleFireEvent);
